package com.safecode.security.browser.controller;
...
import com.safecode.security.browser.social.SocialUserInfo;
...
public class BrowserSecurityController {
    ...
    // 请求缓存 在跳转的时候Spring将当前的请求缓存到了session里面去了
