    ...
    public Server choose(Object key) {
        try {
            ...
            if(theSameClusterNameInstList.isEmpty()) {
                ...
                toBeChooseInstance = WeightBalancer.chooseInstanceByRandomWeight(allInstance);
                ...
                toBeChooseInstance = WeightBalancer.chooseInstanceByRandomWeight(theSameClusterNameInstList);
