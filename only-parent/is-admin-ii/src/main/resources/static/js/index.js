    ...
    $.ajax({
        ...
        error: function () {
            ...
            window.location.href = 'http://auth.safecode.com:8030/oauth/authorize?'
                + 'client_id=adminii&'
                + 'redirect_uri=http://adminii.safecode.com:9010/oauth/callback&'
                + 'response_type=code&'
                + 'state=abc'
        }
    });
                ...
                if (XMLHttpRequest.status == '500') {
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            //重新加载页面
                            //location.reload();
                            window.location.href = 'http://auth.safecode.com:8030/logout?redirect_uri=http://adminii.safecode.com:9010';
                        },
                        error: function () {
                            alert('退出失败');
                        }
