                    ...
                    <div class="thumbnail" style="width: 100%; display: block;margin-bottom: 10px;">
                        ...
                        <div style="height: 40px;">
                            <div class="col-xs-12 left_product">
                                <div class="row">
                                    <a style="cursor: pointer;" href="${basepath}/product/${item.id!''}.html"
                                       target="_blank"
                                       title="${item.name!""}">
                                        ${item.name!""}
                                    </a>
                                ...
                                <#else>
                                    ...
                                    <#if queryType=="d">
                                        ...
                                        <div style="display: inline;" timer="activityEndDateTime"
                                             activityEndDateTime="${item.activityEndDateTime!""}"></div>
                                        <span class="badge pull-right"
                                              style="background-color:red;">${item.discountFormat!""}折</span>
                                    <#elseif queryType=="r">
                                        还剩
                                        <div style="display: inline;" timer="activityEndDateTime"
                                             activityEndDateTime="${item.activityEndDateTime!""}"></div>
