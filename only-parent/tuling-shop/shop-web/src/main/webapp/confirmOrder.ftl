            ...
            <div class="container">
                ...
                <div class="panel panel-primary">
                    ...
                    <ul class="list-group">
                                        ...
                                        <div class="col-xs-12" style="line-height: 20px;" id="adressListDiv">
                                            ...
                                            <#list myCart.addressList as item>
                                                <#if myCart.defaultAddessID?? && item.id == myCart.defaultAddessID>
                                                    <div address="address" class="col-xs-3 alert alert-info"
                                                         style="border: 1px solid;text-align: left;margin-right: 10px;width: 200px;line-height: 20px;cursor: pointer;">
                                                ...
                                                <#else>
                                                    <div address="address" class="col-xs-3 alert"
                                                         style="border: 1px solid;text-align: left;margin-right: 10px;width: 200px;line-height: 20px;cursor: pointer;">
                                                        ${item.name!""},${item.phone!""}
                                ...
                                <#else>
                                    <#if currentAccount()??>
                                        <div class="bs-callout bs-callout-danger author"
                                            ...
                                            暂时还没有收货地址！<a style="text-decoration: underline;"
                                                         href="${basepath}/account/address">点此设置</a>
                                        </div>
                                    </#if>
                                </#if>
                            </#if>
                                    ...
                                    <table class="table table-bordered table-hover" id="expressTable">
                                        <#list expressList as item>
                                            <tr style="cursor: pointer;">
                                                <td width="400px">
                                                    <input type="radio" name="expressCode" value="${item.code!""}"
                                                           fee="${item.fee!""}"/>
                                                    ${item.name!""}</td>
                                                <td>${item.fee!""}</td>
                                            </tr>
                        ...
                        <li class="list-group-item"><span class="glyphicon glyphicon-shopping-cart"></span>&nbsp;购买到的商品
                        </li>
                        <li class="list-group-item">
                            <div class="row">
                                <div class="col-xs-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>&nbsp;<a target="_blank"
                                                    ...
                                                    <a name="stockErrorTips" productid="${item.id!""}" href="#"
                                                       ...
                                                       data-original-title="商品库存不足20个，"></a>
                    ...
                    <div class="panel-footer primary" align="right">
                            ...
                            <div class="col-xs-12">
                                <#if myCart.totalExchangeScore!=0>
                                    <h4>所需积分：<span style="color: red;font-weight: bold;"
                                                   id="totalExchangeScore">${myCart.totalExchangeScore!""}</span>
                                    </h4>
                                </#if>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <input name="otherRequirement" class="form-control"
                                       placeholder="此处您可以输入您的附加要求，以便我们提供更好的服务。" size="50" maxlength="50"/>
                            </div>
                            <div class="col-xs-6">
                                <button type="submit" class="btn btn-success" value="提交订单" id="confirmOrderBtn"
                                        disabled="disabled" data-placement="left">
