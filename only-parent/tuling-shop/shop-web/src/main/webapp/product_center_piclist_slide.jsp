...
<link href="<%=request.getContextPath() %>/resource/js/showProduct/css/magiczoomplus.css" type="text/css"
      rel="stylesheet">
...
<div class="box">
    <div class="left-pro">
        <div class="t1">
            ...
            <div id="showArea">
                <s:iterator value="e.productImageList" status="i" var="img">
                    <a href="<%=SystemManager.getInstance().getSystemSetting().getImageRootPath()%><s:property escape="false" value="image3" />"
                       rel="zoom1"
                       rev="<%=SystemManager.getInstance().getSystemSetting().getImageRootPath()%><s:property escape="false" value="image2" />">
        ...
        <div class="t2">
            <a href="<%=SystemManager.getInstance().getSystemSetting().getImageRootPath()%><s:property escape="false" value="e.picture" />"
