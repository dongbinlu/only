                ...
                <div class="panel-body">
                    <div class="col-md-10 col-md-offset-1">
                        <form role="form" id="form" method="post" class="form-horizontal"
                              action="${basepath}/account/doRegister.html" theme="simple">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-md-offset-1">
                                    ...
                                    <a href="javascript:void(0);" onclick="javascript:reloadImg2();"
                                       class="btn btn-link btn-sm">看不清?换一张</a>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <a target="_blank" id="link-zcxy" class="btn btn-link btn-md"
                                       href="${systemSetting().www}/help/zcxy.html">shop用户注册协议</a>
                                </div>
                            </div>
                            <div class="form-group">
