    ...
    <div class="container" style="margin-top: 0px;padding-top: 0px;">
        <div class="row">
            ...
            <div class="col-xs-9" style="min-height: 200px;">
                ...
                <hr>
                <div class="row">
                    <form role="form" id="form" class="form-horizontal" method="post" action="saveAddress"
                          theme="simple">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" value="${address.name!""}" name="name" type="text"
                                       class="form-control" id="name" data-rule="收货人姓名:required;length[2~8];name;"
                                       placeholder="请输入收货人姓名" maxlength="8" size="8"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" value="${address.address!""}" name="address" type="text"
                                       class="form-control" id="address" data-rule="地址:required;length[0~70];address;"
                                       placeholder="请输入收货人地址" maxlength="70" size="70"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" value="${address.zip!""}" name="zip" type="text"
                                       class="form-control" id="zip" data-rule="邮编:required;length[6];zip;"
                                       placeholder="请输入收货人邮编" size="6" maxlength="6"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" value="${address.mobile!""}" name="mobile" type="text"
                                       class="form-control" id="mobile" data-rule="手机:required;length[10~15];mobile;"
                                       placeholder="请输入收货人手机" maxlength="15"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-lg-6">
                                <input type="text" value="${address.phone!""}" name="phone" type="text"
                                       class="form-control" id="phone" data-rule="电话号码:required;length[0~15];phone;"
                                       placeholder="请输入收货人座机号码" maxlength="15"/>
                            </div>
                        </div>
                        <div class="form-group">
                                ...
                                <tr>
                                    ...
                                    <td nowrap="nowrap" style="text-align: center;">
                                        <#if item.isdefault?? && item.isdefault=="y">
                                            <input type="radio" current="1" name="setDefaultRadio" value="${item.id!""}"
                                                   checked="checked"/>
                                        <#else>
                                    ...
                                    <td style="text-align: center;" nowrap="nowrap">
                                        ...
                                        <a onclick="return deletes();"
                                           href="${basepath}/account/deleteAddress?id=${item.id!""}">
                                            删除
                                        </a>
                                    </td>
                                </tr>
