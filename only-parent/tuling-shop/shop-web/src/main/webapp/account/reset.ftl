                    ...
                    <div class="panel-body" style="font-size: 16px;font-weight: normal;text-align: center;">
                        <#if reset_password_email_timeout??>
                            ...
                            <a style="display: none;" class="btn btn-success btn-sm"
                               href="${systemSetting().www}/accountdoForget.html?account=${e.account!""}"><span
                                        class="glyphicon glyphicon-send"></span>&nbsp;重新发送邮件</a>

                        <#else>

                            <form role="form" name="form" id="form" class="form-horizontal"
                                  action="${basepath}/account/doReset" theme="simple">
