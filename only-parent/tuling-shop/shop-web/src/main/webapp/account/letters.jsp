                    ...
                    <s:iterator value="pager.list" status="i" var="item">
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <a class="title" href="#" onclick="readLitters(this,<s:property value="id"/>);"
                                   title="<s:property value="title"/>" littersStatus="<s:property value="status"/>">
                                    <s:if test="status==0">
                            ...
                            <td style="text-align: center;width: 50px;"><a href="#" onclick="del(this,<s:property
                                    value="id"/>);">删除</a></td>
                        </tr>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-primary" onclick="javascript:$('#myModal').modal('hide');">取消
                </button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal-dialog -->
...
<script type="text/javascript"
        src="<%=request.getContextPath()%>/resource/validator-0.6.3/jquery.validator.js"></script>
