                        ...
                        <table class="table table-bordered">
                            ...
                            <#list pager.list as item>
                                <#if item.product??>
                                    <tr>
                                        <td>
                                            <a href="${basepath}/product/${item.productID!""}" target="_blank"
                                               title="${item.product.name!""}">
                                                <img class="err-product" onerror="defaultProductImg()"
                                                     style="width: 50px;height: 50px;border: 0px;" alt=""
                                                     src="${systemSetting().imageRootPath}/${item.product.picture!""}"/>
                                            </a>
