...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resource/404/1/css/dandelion.css"
          media="screen"/>
    ...
    <div id="da-footer">
        <div class="da-container clearfix">
            <p style="text-align: center;"><%=SystemManager.getInstance().getSystemSetting().getIcp() %>
                <a target="_blank" href="http://www.aliyun.com/"><img
                        src="http://gtms01.alicdn.com/tps/i1/T1W6.aFbFbXXcZj_6s-96-18.png" alt="运行在阿里云"/></a>
            </p>
        </div>
    </div>
</div>
