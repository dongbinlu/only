                        ...
                        <#list hotProductList as item>
                            <div class="row">
                                <div class="col-xs-3">
                                    ...
                                    <a style="width: 50px;height: 50px;" href="${basepath}/product/${item.id!""}.html"
                                ...
                                <div class="col-xs-9">
                                    <h4>
                                        <div class="left_product">
                                            <a title="${item.name!""}" href="${basepath}/product/${item.id!""}.html"
                                               target="_blank">
                                                ${item.name!""}
                                            </a>
                                        </div>
                        ...
                        <div class="col-xs-12">
                            <ol class="breadcrumb" style="margin-bottom: 0px;">
                                ...
                                <#if e.childrenCatalogName??>
                                    <li class="active"><a
                                                href="${systemSetting().www}/catalog/${e.childrenCatalogCode!""}.html">${e.childrenCatalogName!""}</a>
                                    </li>
                                </#if>
                            </ol>
                        </div>
                    ...
                    <div class="row" style="margin-top: 10px;">
                        ...
                        <div class="col-xs-6">
                            <div style="line-height: 20px;">
                                        ...
                                        <ul class="list-group">
                                            <li class="list-group-item">
                                                ...
                                                <div style="display: inline;" timer="activityEndDateTime"
                                                     activityEndDateTime="${e.activityEndDateTime!""}"></div>
                                                <#if e.maxSellCount!=0>
                                                    <br>
                                ...
                                <form action="${basepath}/product/buyNow.html" namespace="/" method="post"
                                      theme="simple">
                                    <div class="row" style="margin-bottom: 10px;">
                                        <div class="col-xs-12">
                                            ...
                                            <input value="1" size="4" maxlength="4" name="inputBuyNum" id="inputBuyNum"
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <#if e.status==2 && e.stock gt 0>
                                                ...
                                                <a name="stockErrorTips" productid="${id!""}" href="#"
                                            ...
                                            <#else>
                                                <button type="button" id="addToCartBtn" onclick="addToCart()"
                                                        value="加入购物车" class="btn btn-primary btn-sm"
                                                        disabled="disabled">
                                                    <span class="glyphicon glyphicon-shopping-cart"></span>加入购物车
                                                </button>
                                            </#if>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" onclick="javascript:$('#myModal').modal('hide');">
                        继续购物
                    </button>
