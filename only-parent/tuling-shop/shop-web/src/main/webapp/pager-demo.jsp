...
<table bgcolor="#ffcc00" width="100%" border="0"
    ...
    <tr>
        <td>
            <table bgcolor="#3366cc" width="100%" border="0"
                   cellspacing="0" cellpadding="4">
                <tr>
                    <td width="379"><a href="http://jsptags.com/"><img src="images/jsptags.gif"
                                                                       alt="&lt;jsptags.com&gt; logo" width="379"
                                                                       height="65" border="0"></a></td>
                    <td width="100%" align="center"><a href="http://jsptags.com/tags/navigation/pager/"
                                                       class="nodec"><font color="#ffffff" size="+2"><b>
    ...
    <center>
            ...
            <tr valign="top">
                <td rowspan="2" align="center">
                    <table border="0" cellspacing="2" cellpadding="0">
                        ...
                        <tr>
                            <td><% radio(pageContext, "style", "simple", true); %></td>
                            <td>Simple</td>
                        </tr>
                        <tr>
                            <td><% radio(pageContext, "style", "texticon", false); %></td>
                            <td>Text Icon</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td><% radio(pageContext, "style", "alltheweb", false); %></td>
                            <td><a target="_blank" href="http://www.alltheweb.com/">AllTheWeb</a></td>
                        </tr>
                        <tr>
                            <td><% radio(pageContext, "style", "altavista", false); %></td>
                            <td><a target="_blank" href="http://www.altavista.com/">AltaVista</a></td>
                        </tr>
                        <tr>
                            <td><% radio(pageContext, "style", "google", false); %></td>
                            <td><a target="_blank" href="http://www.google.com/"><font color="#0000cc">G</font><font
                                    color="#cccc00">oo</font><font color="#0000cc">g</font><font
                                    color="#00cc00">l</font><font color="#cc0000">e</font></a></td>
                        </tr>
                        <tr>
                            <td><% radio(pageContext, "style", "lycos", false); %></td>
                            <td><a target="_blank" href="http://www.lycos.com/">Lycos</a></td>
                        </tr>
                        <tr>
                            <td><% radio(pageContext, "style", "yahoo", false); %></td>
                ...
                <td>
                    <table border="0" cellspacing="2" cellpadding="0">
                        ...
                        <tr>
                            <td><% radio(pageContext, "position", "top", true); %></td>
                            <td>Top</td>
                        </tr>
                        <tr>
                            <td><% radio(pageContext, "position", "bottom", false); %></td>
                            <td>Bottom</td>
                        </tr>
                        <tr>
                            <td><% radio(pageContext, "position", "both", false); %></td>
                            <td>Top&nbsp;&amp;&nbsp;Bottom</td>
                        </tr>
                    </table>
                </td>
                <td>
                    <table border="0" cellspacing="2" cellpadding="0">
                        ...
                        <tr>
                            <td><% radio(pageContext, "index", "center", true); %></td>
                            <td>Center</td>
                        </tr>
                        <tr>
                            <td><% radio(pageContext, "index", "forward", false); %></td>
                            <td>Forward</td>
                        </tr>
                        <tr>
                            <td><% radio(pageContext, "index", "half-full", false); %></td>
                            <td>Half-Full</td>
                        </tr>
                    </table>
                </td>
                    ...
                    <table border="0" cellspacing="0" cellpadding="0">
                        <tr valign="top">
                            ...
                            <td><font color="#0000cc">G</font><font color="#cccc00">oo</font><font
                                    color="#0000cc">g</font><font color="#00cc00">l</font><font color="#cc0000">e</font>
            ...
            <tr>
                <td colspan="2" align="center" valign="top">
                    <table border="0" cellspacing="2" cellpadding="0">
                        <tr>
                            <td>Max.&nbsp;Page&nbsp;Items&nbsp;</td>
                            <td><input type="text" size="4" name="maxPageItems" value="<%= maxPageItems %>"
                                       onChange="this.form.submit();"></td>
                        </tr>
                        <tr>
                            <td>Max.&nbsp;Index&nbsp;Pages&nbsp;</td>
                            <td><input type="text" size="4" name="maxIndexPages" value="<%= maxIndexPages %>"
                                       onChange="this.form.submit();"></td>
                        </tr>
                    </table>
                </td>
        ...
        <pg:pager
            ...
            <table width="90%" cellspacing="4" cellpadding="4">
                ...
                %><pg:item>
                <tr>
                    <th bgcolor="<%= webPalette[i][0] %>"><font color="<%= webPalette[i][1] %>"><%= i + 1 %>
                    </font></th>
                </tr>
            </pg:item><%
                }
