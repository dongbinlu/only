                ...
                <div class="col-xs-12" style="border: 0px solid;text-align: left;">
                    <#if productList?? && productList?size gt 0>
                        ...
                        <table id="result_table" class="table table-bordered">
                            ...
                            <#list productList as item>
                                <tr>
                                    ...
                                    <td>&nbsp;<a target="_blank"
                                                 href="${basepath}/product/${item.id!""}.html">${item.name!""}</a>
                                        <#if item.exchangeScore!=0>
                                            <p>
												<span id="totalExchangeScoreSpan"
                                                      class="label label-default">兑换积分:${item.exchangeScore!""}
												</span>
                                            </p>
                                        </#if>
                                    ...
                                    <td>
                                        <span onclick="subFunc(this,true)" style="cursor: pointer;"><img
                                                    src="${basepath}/resource/images/minimize.png"
                                                    style="vertical-align: middle;"/></span>
                                        <input style="text-align: center;" name="inputBuyNum"
                                               value="${item.buyCount!""}" size="4" maxlength="4" pid="${item.id!""}"/>
                                        <!-- 										<a name="stockErrorTips" href="#" data-toggle="tooltip" data-placement="right" title=""></a> -->

                                        <a name="stockErrorTips" productid="${item.id!""}" href="#"
                                           data-toggle="tooltip" title="" data-placement="right"></a>

                                        <span onclick="addFunc(this,true)" style="cursor: pointer;"><img
                                                    src="${basepath}/resource/images/maximize.png"
                                                    style="vertical-align: middle;"/></span>
                                    </td>
                                    <td total0="total0">&nbsp;
                                        ${item.total0!""}
                        ...
                        <div style="border: 0px solid;float: right;margin-right: 20px;">
                            <div class="row">
                                <h4>合计：<span style="color: red;font-weight: bold;"
                                             id="totalPayMonery">${cartInfo.amount!""}</span>
                                </h4>
                            </div>

                            <div class="row">
                                <#if cartInfo.totalExchangeScore!=0>
                                    <h4>所需积分：<span style="color: red;font-weight: bold;"
                                                   id="totalExchangeScore">${cartInfo.totalExchangeScore!""}</span>
                                    </h4>
                                </#if>
                            </div>

                            <div class="row">
                                <a href="${basepath}/order/confirmOrder.html" data-toggle="show" data-placement="top"
                                   class="btn btn-success" id="confirmOrderBtn" onclick="return confirmOrder()"
                                   disabled="disabled">
                    ...
                    <#else>
                        ...
                        <div class="bs-callout bs-callout-danger author"
                             style="text-align: left;font-size: 22px;margin: 2px 0px;">
