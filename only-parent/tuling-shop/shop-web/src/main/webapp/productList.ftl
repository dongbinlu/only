...
<@html.htmlBase>
    <style type="text/css">
        ...
        img.err-product {
        <#if systemSetting().defaultProductImg??> background: url(${systemSetting().defaultProductImg}) no-repeat 50% 50%;
                        ...
                        <div style="border: 0px solid;text-align: left;">
                            <div>
                                <ol class="breadcrumb" style="margin-bottom: 0px;">
                                    <li class="active"><a
                                                href="${basepath}/catalog/${mainCatalogCode}.html">${e.mainCatalogName!""}</a>
                                    </li>
                        ...
                        <#if catalogChildren??>
                            <div>
                                ...
                                <#list catalogChildren as item>
                                    <span class="label ${(catalogCode?? && item.code==catalogCode)?string("label-success","label-info2")}"
                                          style="margin:5px;font-size:100%;">
                ...
                <#if productList?? && productList?size gt 0>
                    <div class="row" style="margin: 0px;">
                        <div class="col-xs-12">
                            ...
                            <span class="label ${(e.orderBy??&&e.orderBy==1)?string('label-success','')} attr_css"
                                  style="margin:5px;">
									<a href="${basepath}/catalog/${catalogCode!""}.html?orderBy=1&attrID=${e.attrID!""}">热门</a>
								</span>

                            <span class="label ${(e.orderBy??&&e.orderBy==2)?string('label-success','')}  attr_css"
                                  style="margin:5px;">
									<a href="${basepath}/catalog/${catalogCode!""}.html?orderBy=2&attrID=${e.attrID!""}">价格</a>
								</span>

                            <span class="label ${(e.orderBy??&&e.orderBy==3)?string('label-success','')}  attr_css"
                                  style="margin:5px;">
