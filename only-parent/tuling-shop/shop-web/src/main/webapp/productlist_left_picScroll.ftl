...
<style type="text/css">
    ...
    .picScroll-top .hd .prev, .picScroll-top .hd .next {
        ...
        overflow: hidden;
        cursor: pointer;
        background: url("${basepath}/resource/js/superSlide/demo/images/icoUp.gif") no-repeat;
    }

    .picScroll-top .hd .next {
        background: url("${basepath}/resource/js/superSlide/demo/images/icoDown.gif") no-repeat;
    }
    ...
    .picScroll-top .hd ul li {
        ...
        text-indent: -999px;
        cursor: pointer;
        background: url("${basepath}/resource/js/superSlide/demo/images/icoCircle.gif") 0 -9px no-repeat;
    }
                ...
                <#list systemManager().getProductsByCatalogCode(_code) as item>
                    <li class="row col-xs-12">
                        <div class="pic"><a href="${basepath}/product/${item.id}" target="_blank">
                                <img border="0" style="margin: auto;"
                                     src="${systemSetting().imageRootPath}/${item.picture!""}"/></a>
                        </div>
                        <div class="left_title" style="text-align: center;">
                            <a href="${basepath}/product/${item.id}" target="_blank"
                               style="margin: auto;text-align: center;" title="${item.name!""}">
                                ${item.name!""}
                            </a>
                        </div>
                        <div class="left_title" style="text-align: center;">
