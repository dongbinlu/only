...
<link rel="stylesheet" href="<%=request.getContextPath()%>/resource/bootstrap3.3.4/css/<%=style %>/bootstrap.min.css"
      type="text/css">
...
//if(SystemManager.systemSetting.getOpenResponsive().equals("n") || (responsive_session!=null && responsive_session.toString().equals("n"))){
    ...
    if (non_responsive) {
%>
<link rel="stylesheet" href="<%=request.getContextPath()%>/resource/bootstrap3.3.4/css/non-responsive.css"
      type="text/css">
<%} %>
