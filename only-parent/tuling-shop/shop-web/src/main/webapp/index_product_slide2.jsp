...
<style type="text/css">
    ...
    .multipleColumn .hd .prev, .multipleColumn .hd .next {
        ...
        overflow: hidden;
        cursor: pointer;
        background: url("<%=request.getContextPath() %>/resource/js/superSlide/demo/images/icoLeft.gif") no-repeat;
    }

    .multipleColumn .hd .next {
        background: url("<%=request.getContextPath() %>/resource/js/superSlide/demo/images/icoRight.gif") no-repeat;
    }
    ...
    .multipleColumn .hd ul li {
        ...
        text-indent: -999px;
        cursor: pointer;
        background: url("<%=request.getContextPath() %>/resource/js/superSlide/demo/images/icoCircle.gif") 0 -9px no-repeat;
    }
    ...
    <div class="bd">
        ...
        <div class="ulWrap">
            ...
            <ul><!-- 把每次滚动的n个li放到1个ul里面 -->
                <li>
                    <div class="pic"><a href="http://www.SuperSlide2.com" target="_blank"><img
                            src="<%=request.getContextPath() %>/resource/js/superSlide/demo/images/pic1.jpg"/></a></div>
            ...
            <ul><!-- 把每次滚动的n个li放到1个ul里面 -->
                <li>
                    <div class="pic"><a href="http://www.SuperSlide2.com" target="_blank"><img
                            src="<%=request.getContextPath() %>/resource/js/superSlide/demo/images/pic2.jpg"/></a></div>
            ...
            <ul><!-- 把每次滚动的n个li放到1个ul里面 -->
                <li>
                    <div class="pic"><a href="http://www.SuperSlide2.com" target="_blank"><img
                            src="<%=request.getContextPath() %>/resource/js/superSlide/demo/images/pic3.jpg"/></a></div>
            ...
            <ul><!-- 把每次滚动的n个li放到1个ul里面 -->
                <li>
                    <div class="pic"><a href="http://www.SuperSlide2.com" target="_blank"><img
                            src="<%=request.getContextPath() %>/resource/js/superSlide/demo/images/pic4.jpg"/></a></div>
