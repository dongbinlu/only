...
<div class="lanrenzhijia">
    ...
    <div class="product-wrap">
        ...
        <div class="product show">
            <ul class="cf">
                <li class="ml0"><a href="http://www.xwcms.net" class="imgwrap"> <img
                        src="<%=request.getContextPath() %>/resource/js/slideTab1/images/1.jpg"> </a>
                    <p class="mt10"><a href="http://www.xwcms.net">站长素材网站logo... </a></p>
                    <p class="pb10">行业类别：艺术摄影,文化体育</p>
                </li>
                <li><a href="http://www.xwcms.net" class="imgwrap"> <img
                        src="<%=request.getContextPath() %>/resource/js/slideTab1/images/1.jpg"> </a>
        ...
        <div class="product">
            <ul class="cf">
                <li class="ml0"><a href="http://www.xwcms.net" class="imgwrap"> <img
                        src="<%=request.getContextPath() %>/resource/js/slideTab1/images/2.jpg"> </a>
                    <p class="mt10"><a href="http://www.xwcms.net"> 深圳达文影视传媒有限公司logo... </a></p>
                    <p class="pb10">行业类别：艺术摄影,文化体育</p>
                </li>
                <li><a href="http://www.xwcms.net" class="imgwrap"> <img
        ...
        <div class="product">
            <ul class="cf">
                <li class="ml0"><a href="http://www.xwcms.net" class="imgwrap"> <img
                        src="<%=request.getContextPath() %>/resource/js/slideTab1/images/3.jpg"> </a>
                    <p class="mt10"><a href="http://www.xwcms.net"> 深圳达文影视传媒有限公司logo... </a></p>
                    <p class="pb10">行业类别：艺术摄影,文化体育</p>
                </li>
                <li><a href="http://www.xwcms.net" class="imgwrap"> <img
        ...
        <div class="product">
            <ul class="cf">
                <li class="ml0"><a href="http://www.xwcms.net" class="imgwrap"> <img
                        src="<%=request.getContextPath() %>/resource/js/slideTab1/images/4.jpg"> </a>
                    <p class="mt10"><a href="http://www.xwcms.net"> 深圳达文影视传媒有限公司logo... </a></p>
                    <p class="pb10">行业类别：艺术摄影,文化体育</p>
                </li>
                <li><a href="http://www.xwcms.net" class="imgwrap"> <img
        ...
        <div class="product">
            <ul class="cf">
                <li class="ml0"><a href="http://www.xwcms.net" class="imgwrap"> <img
                        src="<%=request.getContextPath() %>/resource/js/slideTab1/images/5.jpg"> </a>
                    <p class="mt10"><a href="http://www.xwcms.net"> 深圳达文影视传媒有限公司logo... </a></p>
                    <p class="pb10">行业类别：艺术摄影,文化体育</p>
                </li>
                <li><a href="http://www.xwcms.net" class="imgwrap"> <img
