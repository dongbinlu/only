<#macro menu selectMenu="0">
    ...
    <div class="navbar navbar-default"
        ...
        <div class="container" style="min-height: 10px;margin-top:5px;margin-bottom:5px;border: 0px solid red;">
            <div class="row">
                <div class="col-xs-3">
                    <a href="${systemSetting().www}/index"><img style="max-height: 50px;" alt="myshop-logo"
                                                                src="${systemSetting().log}"/></a>
                </div>
                        ...
                        <#if currentAccount()??>
                            <span id="myshopMenuPPP" style="display: inline-block;z-index: 9999;position: relative;;">
							  ...
							  <ul class="dropdown-menu" id="myshopMenu" role="menu"
                                  ...
                                  <li><a href="${basepath}/account/account"><span
                                                  class="glyphicon glyphicon-user"></span>&nbsp;个人资料</a></li>
                                  <li><a href="${basepath}/account/topwd"><span
                                  ...
                                  <li><a href="${basepath}/account/orders"><span class="glyphicon glyphicon-th"></span>&nbsp;我的订单</a></li>
                                   <li><a href="${basepath}/account/score"><span
                                                   class="glyphicon glyphicon-asterisk"></span>&nbsp;我的积分</a></li>
                                  <li><a href="${basepath}/account/address"><span
                                                  class="glyphicon glyphicon-send"></span>&nbsp;配送地址</a></li>
                                  <li><a href="${basepath}/account/favorite"><span
            ...
            <div class="navbar-collapse collapse" id="navbar-main">
                <ul class="nav navbar-nav">
                    ...
                    <#list systemManager().catalogs as item>
                        <#if item.showInNav == "y">
                            <li class="${(item.code == selectMenu)?string("active","")}"><a
                                        href="${basepath}/catalog/${item.code}.html"><b>${item.name}</b></a></li>
                        </#if>
                    </#list>
                </ul>
                ...
                <ul class="nav navbar-nav navbar-right" style="display: block;">
                    ...
                    <!-- 团购活动 -->
                    <#if false>
                        <li class="${(selectMenu=="tuan")?string("active","")}"><a
                                    href="${basepath}/activity/tuan.html">
                                <b>团购活动</b></a>
                        </li>
                    </#if>
                </ul>
