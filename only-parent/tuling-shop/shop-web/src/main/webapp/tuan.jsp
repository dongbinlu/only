...
<head>
    ...
    <style type="text/css">
        ...
        img.err-product {
        <%if(StringUtils.isNotBlank(SystemManager.getInstance().getSystemSetting().getDefaultProductImg())){%> background: url(<%=SystemManager.getInstance().getSystemSetting().getDefaultProductImg()%>) no-repeat 50% 50%;
        <%}%>
        }
