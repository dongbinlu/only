<#macro htmlBase title="" jsFiles=[] cssFiles=[] staticJsFiles=[] staticCssFiles=[] checkLogin=true>
    ...
    <head>
        ...
        <link rel="stylesheet"
              href="${staticpath}/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.css"/>
        <script charset="utf-8"
                src="${staticpath}/datatables-plugins/integration/bootstrap/3/dataTables.bootstrap.js"></script>
