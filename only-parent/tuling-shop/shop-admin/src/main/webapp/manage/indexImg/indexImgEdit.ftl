        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td style="text-align: left;" colspan="3">
                    ...
                    <input type="text" value="${e.picture!""}" name="picture" id="picture" ccc="imagesInput"
            ...
            <tr>
                ...
                <td style="text-align: left;"><input type="text" value="${e.order1!""}" name="order1"
                                                     data-rule="排序:integer;order1;length[1~5];"
                                                     id="order1"/></td>
            </tr>
            <tr>
                <th>描述</th>
                <td style="text-align: left;"><input type="text" value="${e.desc1!""}" name="desc1"
                                                     data-rule="排序:desc1;length[1~100];"
                                                     id="desc1"/></td>
            </tr>
            <tr>
