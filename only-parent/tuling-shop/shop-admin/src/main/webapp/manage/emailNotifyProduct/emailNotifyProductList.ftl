    ...
    <form action="${basepath}/manage/emailNotifyProduct" namespace="/manage" method="post" theme="simple">
        <table class="table table-bordered">
            <tr>
                ...
                <td style="text-align: left;"><input type="text" value="${e.account!""}" name="account"
                                                     class="search-query input-small"
                                                     id="account"/></td>
                <td style="text-align: right;" nowrap="nowrap">接收到货的邮箱</td>
                <td style="text-align: left;"><input type="text" value="${e.receiveEmail!""}" name="receiveEmail"
                                                     class="input-small"
                                                     id="receiveEmail"/></td>
        ...
        <table class="table table-bordered table-hover">
            ...
            <#list pager.list as item>
                <tr>
                    ...
                    <td nowrap="nowrap">&nbsp;
                        <a href="${systemSetting().www}/product/${item.productID!""}.html" target="_blank"
