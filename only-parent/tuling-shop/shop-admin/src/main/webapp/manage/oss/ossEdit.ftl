    ...
    <form action="${basepath}/manage/oss" method="post" theme="simple" id="form" name="form">
        <table class="table table-bordered">
            ...
            <tr style="display: none;">
                <td>id</td>
                <td>
                    <intput type="hidden" value="${e.id!""}" name="id" label="id"/>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    <input type="text" value="${e.aliyunOSS.ACCESS_ID!""}" name="aliyunOSS.ACCESS_ID" id="ACCESS_ID"
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    <input type="text" value="${e.aliyunOSS.ACCESS_KEY!""}" name="aliyunOSS.ACCESS_KEY" id="ACCESS_KEY"
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    <input type="text" value="${e.aliyunOSS.OSS_ENDPOINT!""}" name="aliyunOSS.OSS_ENDPOINT"
                           id="OSS_ENDPOINT" data-rule="OSS_ENDPOINT:required;OSS_ENDPOINT;length[1~50];"/>
                </td>
            </tr>
            <tr>
                <td style="text-align: right;">bucketName</td>
                <td style="text-align: left;">
                    <input type="text" value="${e.aliyunOSS.bucketName!""}" name="aliyunOSS.bucketName" id="bucketName"
