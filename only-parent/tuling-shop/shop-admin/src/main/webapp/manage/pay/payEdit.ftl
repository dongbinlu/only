    ...
    <form action="${basepath}/manage/pay" theme="simple">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td style="text-align: left;"><input type="text" value="${e.seller!""}" name="seller"
                                                     data-rule="卖家账号:required;seller;length[1~45];"
                                                     id="seller"/></td>
            </tr>
            <tr>
                <td style="text-align: right;">合作身份者ID</td>
                <td style="text-align: left;"><input type="text" value="${e.partner!""}" name="partner"
                                                     data-rule="合作身份者ID:required;partner;length[1~45];"
                                                     id="partner"/></td>
            </tr>
            <tr>
                <td style="text-align: right;">商户的私钥</td>
                <td style="text-align: left;"><input type="text" value="${e.key1!""}" name="key1"
                                                     data-rule="商户的私钥:required;key1;length[1~45];"
                                                     id="key1"/></td>
            </tr>
            <tr>
                <td style="text-align: right;">排序</td>
                <td style="text-align: left;"><input type="text" value="${e.order1!""}" name="order1"
                                                     data-rule="排序:integer;order1;"
                                                     id="order1"/></td>
            </tr>
            <tr>
