        ...
        <div class="table-responsive">
            <table class="table table-bordered">
                <tr>
                    ...
                    <td style="text-align: left;"><input type="text" value="${e.nickname!""}" name="nickname"
                                                         class="input-small"
                                                         id="nickname"/></td>
                    ...
                    <td style="text-align: left;">
                        ...
                        <select id="rank" name="rank" class="input-medium">
                            <#list map?keys as key>
                                <option value="${key}"
                                        <#if e.rank?? && e.rank==key>selected="selected" </#if>>${map[key]}</option>
                            </#list>
                        </select>
                    ...
                    <td style="text-align: left;">
                        ...
                        <select id="freeze" name="freeze" class="input-medium">
                            <#list map?keys as key>
                                <option value="${key}"
                                        <#if e.freeze?? && e.freeze==key>selected="selected" </#if>>${map[key]}</option>
                            </#list>
                        </select>
                    </td>
