            ...
            <div id="tabs-1">
                <table class="table table-condensed">
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;"><input type="text" name="version" value="${e.version!""}"
                                                             id="version" data-rule="required;version;length[0~100];"/>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;"><input type="text" name="manageHttp" size="100"
                                                             value="${e.manageHttp!""}"
                                                             id="manageHttp"
                                                             data-rule="required;manageHttp;length[1~100];"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <input type="text" id="keywords" name="keywords" value="${e.keywords!""}"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <input type="text" id="shortcuticon" name="shortcuticon" value="${e.shortcuticon!""}"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <input type="text" id="icp" name="icp" value="${e.icp!""}"
                    ...
                    <tr>
                        ...
                        <td style="text-align: left;">
                            <textarea id="statisticsCode" cols="300" rows="6" name="statisticsCode"
                                      data-rule="required;statisticsCode;length[10~1000];">${e.statisticsCode!""}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right;">是否开放网站</td>
                        <td style="text-align: left;">
                            <input type="checkbox" id="isopen" name="isopen" value="true"
                                   <#if e.isopen=="true">checked="checked"</#if> />
                        </td>
                    </tr>
                    <tr>
            ...
            <div id="tabs-2">
                <table class="table table-condensed">
                        ...
                        <td style="text-align: left;">
                            ...
                            <select id="unit" name="openResponsive">
                                <#list y_n?keys as key>
                                    <option value="${key}"
                                            <#if e.openResponsive?? && e.openResponsive==key>selected="selected" </#if>>${y_n[key]}</option>
                                </#list>
                            </select>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="text-align: left;"><input type="text" name="imageRootPath"
                                                             value="${e.imageRootPath!""}"
                                                             id="imageRootPath"
                                                             data-rule="required;imageRootPath;length[0~100];"/></td>
                    </tr>
                    <tr>
                        <td style="text-align: right;">产品默认图片</td>
                        <td style="text-align: left;"><input type="text" name="defaultProductImg"
                                                             value="${e.defaultProductImg!""}"
                                                             id="defaultProductImg"
                                                             data-rule="required;defaultProductImg;length[0~100];"/>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right;width: 100px">后台左侧菜单叶子节点的图标</td>
                        <td style="text-align: left;"><input type="text" name="manageLeftTreeLeafIcon"
                                                             value="${e.manageLeftTreeLeafIcon!""}"
                                                             id="manageLeftTreeLeafIcon"
                                                             data-rule="required;manageLeftTreeLeafIcon;length[0~100];"/>
                        </td>
                    </tr>
                </table>
            </div>
                        ...
                        <td style="text-align: left;">
                            ...
                            <select id="style" name="style" class="input-medium" onchange="changeStyle()">
                                <#list styles?keys as key>
                                    <option value="${key}"
                                            <#if e.style?? && e.style==key>selected="selected" </#if>>${styles[key]}</option>
                                </#list>
                            </select>
                            <br>
                ...
                <table class="table table-bordered">
                    <tr>
                        <td style="text-align: left;" colspan="2">
                            ...
                            <textarea name="qqHelpHtml"
                                      style="width:100%;height:200px;visibility:hidden;">${e.qqHelpHtml!""}</textarea>
                        </td>
                    </tr>
                </table>
            </div>
            <div id="tabs-6">
                <div>
                    ...
                    <table class="table table-bordered">
                        <tr>
                            <td colspan="11">
                                <input style="display: none;" onclick="addTrFunc();" value="添加" class="btn btn-warning"
                                       type="button"/>
                                ...
                                <td>
                                    <a href="${systemSetting().imageRootPath}/${img}" target="_blank">
                                        <img style="max-width: 100px;max-height: 100px;" alt=""
                                             src="${systemSetting().imageRootPath}/${img}">
                                    </a>
                                </td>
                            </tr>
                        </#list>
