    ...
    <form action="${basepath}/manage/accountRank" method="post" theme="simple" id="form">
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td style="text-align: left;"><input type="text" value="${e.code!""}" name="code" id="code"
                                                     data-rule="code:required;code;length[1~10];"/></td>
            </tr>
            <tr>
                <td style="text-align: right;">等级名称</td>
                <td style="text-align: left;"><input type="text" value="${e.name!""}" name="name"
                                                     data-rule="等级名称:required;name;length[1~10];"
                                                     id="name"/></td>
            </tr>
            <tr>
                <td style="text-align: right;">最小积分</td>
                <td style="text-align: left;"><input type="text" value="${e.minScore!""}" name="minScore"
                                                     data-rule="最小积分:integer;minScore;length[1~10];"
                                                     id="minScore"/></td>
            </tr>
            <tr>
                <td style="text-align: right;">最大积分</td>
                <td style="text-align: left;"><input type="text" value="${e.maxScore!""}" name="maxScore"
                                                     data-rule="最大积分:integer;maxScore;length[1~10];"
                                                     id="maxScore"/></td>
            </tr>
            <tr>
