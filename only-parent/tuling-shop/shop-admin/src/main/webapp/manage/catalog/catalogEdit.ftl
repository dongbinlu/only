        ...
        <table class="table table-bordered" style="width: 95%;margin: auto;">
            ...
            <tr>
                ...
                <td style="text-align: left;"><input type="text" value="${e.name!""}" name="name" id="name"
                                                     data-rule="名称;required;name;" size="20" maxlength="20"
                    /></td>
            </tr>
            <tr>
                ...
                <td style="text-align: left;">
                    ...
                    <input type="text" value="${e.code!""}" name="code"
                           data-rule="编码;required;code;length[1~45];remote[uniqueCode, id]" size="45" maxlength="45"
                           id="code"/></td>
                    ...
                    <td style="text-align: left;">
                        ...
                        <select id="showInNav" name="showInNav" class="input-medium">
                            <#list map?keys as key>
                                <option value="${key}"
                                        <#if e.showInNav?? && e.showInNav==key>selected="selected" </#if>>${map[key]}</option>
                            </#list>
                        </select>
                    </td>
                </tr>
