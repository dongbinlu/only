    ...
    <form action="${basepath}/manage/gift" namespace="/manage" theme="simple" name="form" id="form">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td style="text-align: left;"><input type="text" value="${e.giftName!""}" name="giftName"
                                                     style="width: 80%;" id="giftName"
                                                     data-rule="赠品名称:required;giftName;length[1~100];"/></td>
            </tr>
            <tr>
                <td style="text-align: right;width: 80px;">赠品价值</td>
                <td style="text-align: left;"><input type="text" value="${e.giftPrice!""}" name="giftPrice"
                                                     id="giftPrice"
            ...
            <tr>
                ...
                <td style="text-align: left;" colspan="3">
                    ...
                    <input type="text" value="${e.picture!""}" name="picture" type="text" id="picture" ccc="imagesInput"
                           style="width: 600px;"
