                    ...
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <td><input name="ordership.shipname" type="text" value="${e.ordership.shipname}"
                                       id="name" data-rule="收货人姓名:required;length[2~8];name;" placeholder="请输入收货人姓名"/>
                            </td>
                        </tr>
                        <tr>
                            <td>地址区域</td>
                            <td>
                                <input type="hidden" name="ordership.province" value="${e.ordership.province!"" }"
                                       id="provinceName"/>
                                ...
                                <input type="hidden" name="ordership.city" value="${e.ordership.city!"" }"
                                       id="cityName"/>
                                ...
                                <input type="hidden" name="ordership.area" value="${e.ordership.area!"" }"
                                       id="areaName"/>
                        ...
                        <tr>
                            ...
                            <td>
								<textarea class="form-control" name="ordership.shipaddress" type="text"
                                          id="address" data-rule="地址:required;length[0~70];address;"
                                          placeholder="请输入收货人地址">${e.ordership.shipaddress}</textarea>
                            </td>
                        </tr>
                        <tr>
                            <td>邮编</td>
                        ...
                        <tr>
                            ...
                            <td><input name="ordership.phone" type="text" value="${e.ordership.phone}"
                                       id="mobile" data-rule="手机:required;length[0~70];mobile;" placeholder="请输入收货人手机"/>
                            </td>
                        </tr>
                        <tr>
                            <td>电话号码</td>
                            <td><input name="ordership.tel" type="text" value="${e.ordership.tel}"
                                       id="phone" data-rule="电话号码:required;length[0~70];phone;"
                        ...
                        <tr>
                            <td colspan="2" style="text-align: center;">
                                ...
                                <input type="button" value="返回" class="btn btn-default btn-sm"
