        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    ...
                    <select id="code" name="code" class="input-medium" data-rule="模板:required;code;"
                            onchange="changeTemplate()">
                        <option value=""></option>
                        <#list notifyTemplateList as item>
                            <option value="${item.code}"
                                    <#if e.code?? && e.code==item.code>selected="selected" </#if>>${item.name}</option>
                        </#list>
                    </select>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    <textarea name="template" id="template" style="width:100%;height:400px;visibility:hidden;"
                              data-rule="模板内容:required;template;">${e.template!""}</textarea>
            </tr>
            <tr>
