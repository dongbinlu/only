        ...
        <table class="table table-bordered">
            ...
            <tr>
                <td colspan="16">
                    ...
                    <button method="updateStatusY" class="btn btn-warning"
                            onclick="return submitIDs(this,'确定显示指定的记录吗？');">
                        <i class="icon-arrow-up icon-white"></i> 显示
                    </button>
                    <button method="updateStatusN" class="btn btn-warning"
            ...
            <#list pager.list as item>
                <tr>
                    ...
                    <td>
                        ...
                        <a target="_blank"
                           href="${systemSetting().www}/product/${item.productID!""}.html">${item.productID!""}</a>
                    </td>
                    <td>
                        <a target="_blank"
                           href="${basepath}/manage/account/show?account=${item.account!""}">${item.account!""}
                        </a>
                    </td>
                    <td>&nbsp;
                        <a target="_blank"
                           href="${basepath}/manage/order/toEdit?type=show&id=${item.orderID!""}">${item.orderID!""}</a>
                    </td>
                    <td width="500px">&nbsp;
                        ${item.content!""}<br>
