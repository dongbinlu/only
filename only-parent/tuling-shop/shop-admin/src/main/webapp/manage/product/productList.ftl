    ...
    <form action="${basepath}/manage/product" namespace="/manage" method="post" theme="simple">
        ...
        <table class="table table-bordered table-condensed">
            <tr>
                ...
                <td style="text-align: left;"><input type="text" value="${e.id!""}" name="id"
                ...
                <td style="text-align: left;">
                    ...
                    <select id="status" name="status" class="input-medium">
                        <#list map?keys as key>
                            <option value="${key}"
                                    <#if e.status?? && e.status==key?eval>selected="selected" </#if>>${map[key]}</option>
                        </#list>
                </td>
            ...
            <tr>
                <td colspan="20">
                    ...
                    <#if checkPrivilege("product/updateUp")>
                        ...
                        <button method="updateUp" class="btn btn-warning"
                    ...
                    <#if checkPrivilege("product/updateDown")>
                        <button method="updateDown" class="btn btn-warning"
                    ...
                    <a target="_blank" href="${systemSetting().www}/product/selectMemoryStock.html"
                       class="btn btn-info">
