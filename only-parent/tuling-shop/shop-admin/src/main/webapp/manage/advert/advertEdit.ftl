    ...
    <form action="${basepath}/manage/advert" theme="simple" name="form1">
        <table class="table table-bordered" style="width: 95%;margin: auto;">
            ...
            <tr>
                ...
                <td style="text-align: left;"><input type="text" value="${e.title!""}" name="title"
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    ...
                    <select id="useImagesRandom" name="useImagesRandom" class="input-medium">
                        <#list map?keys as key>
                            <option value="${key}"
                                    <#if e.useImagesRandom?? && e.useImagesRandom==key>selected="selected" </#if>>${map[key]}</option>
                        </#list>
                    </select>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    <textarea name="html" style="width:100%;height:300px;visibility:hidden;"
                              data-rule="内容:required;content;">${e.html!""}</textarea>
                </td>
            </tr>
        </table>
    </form>
