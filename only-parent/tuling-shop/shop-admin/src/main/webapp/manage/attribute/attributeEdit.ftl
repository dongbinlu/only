    ...
    <form action="${basepath}/manage/attribute" theme="simple" id="form">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td style="text-align: left;"><input type="text" value="${e.name!""}" name="name"
                                                     data-rule="required;name;length[1~20];"
                                                     id="name"/></td>
            </tr>
            <tr>
            ...
            <tr id="cloneTR" style="display:none;">
                ...
                <td style="text-align: left;">
                    ...
                    <span style="margin-left:150px;"></span> 显示顺序：<input type="text" value="${e.order1List!""}"
                                                                         name="order1List" number="y"
                                                                         placeholder="请输入属性显示的顺序" value="0" size="5"
                                                                         maxlength="5"/>
                </td>
            </tr>
                ...
                <#list e.attrList as item>
                    <#if item_index == 0><!-- 第一个不能删除 -->
                        <tr class="pclass">
                            <td class="leftTD_css">名称</td>
                            <td style="text-align: left;">
                                <input type="text" name="attrNames0" id="attrNames0" value="${item.name!""}"
                                       data-rule="required;attrNames0;length[1~20];"/>
                                <input type="text" name="idList0" id="idList0" value="${item.id!""}"
                                       data-rule="required;idList0;length[1~20];" style="display:none;"/>
                                <span style="margin-left:150px;"></span> 显示顺序：<input type="text" name="order1List0"
                                                                                     number="y" id="order1List0"
                                                                                     value="${item.order1!""}" size="5"
                                                                                     maxlength="5"
                                                                                     data-rule="required;integer;order1List0;length[1~5];"/>
                            </td>
                        </tr>
                    <#else>
                        <tr class="pclass">
                            ...
                            <td style="text-align: left;">
                                ...
                                <span style="margin-left:150px;"></span> 显示顺序：<input type="text" name="order1List"
                                                                                     number="y" id="order1List"
                                                                                     value="${item.order1!""}" size="5"
                                                                                     maxlength="5"
                                                                                     data-rule="required;integer;order1List;length[1~5];"/>
                            </td>
                        </tr>
                    </#if>
                </#list>
            <#else>
                <tr class="pclass">
                    <td class="leftTD_css">名称</td>
                    <td style="text-align: left;">
                        <input type="text" value="${e.attrNames0!""}" name="attrNames0" id="attrNames0"
                               data-rule="required;attrNames0;length[1~20];" placeholder="请输入属性名称"/>
                        <span style="margin-left:150px;"></span> 显示顺序：<input type="text" value="${e.order1List0!""}"
                                                                             name="order1List0" number="y"
                                                                             id="order1List0" size="5" maxlength="5"
                                                                             data-rule="required;order1List0;integer;length[1~5];"
                                                                             placeholder="请输入属性显示的顺序"/>
                    </td>
                </tr>
            </#if>
        </table>
