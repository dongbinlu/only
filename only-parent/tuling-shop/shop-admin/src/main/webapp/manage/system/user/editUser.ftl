    ...
    <form action="${basepath}/manage/user" id="form" method="post">
        ...
        <table class="table table-bordered">
            ...
            <tr>
                ...
                <td style="text-align: left;">
                    <input type="text" name="nickname" value="${e.nickname!""}" id="nickname"
                           data-rule="昵称:required;nickname;length[2~20];remote[unique, id]"/>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td style="text-align: left;"><input type="password" name="newpassword2"
                    ...
                    <select name="rid">
                        ...
                        <#--${item.id}-->
                            <option value="${item.id}"
                                    <#if e.rid?? && item.id?string == e.rid?string>selected="selected"</#if>> ${item.role_name}</option>
                        </#list>
                    </select>
                </td>
            </tr>
