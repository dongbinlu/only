            ...
            <tr>
                <td colspan="11">
                    <#if checkPrivilege("/manage/user/search") >
                        <button method="selectList" id="btnSearch" class="btn btn-primary" table-id="dataTables-example"
                                onclick="return selectList(this)">
                            <i class="icon-search icon-white"></i> 查询
                        </button>
                    </#if>
                    <#if checkPrivilege("/manage/user/insert") >
                        <a href="${basepath}/manage//user/toAdd" class="btn btn-success"><i
                                    class="icon-plus-sign icon-white"></i> 添加</a>
                    </#if>
