                ...
                <td style="text-align: left;">
                    <select name="role_dbPrivilege" id="role_dbPrivilege">
                        ...
                        <#list map_dbPrivilege?keys as item>
                            <option value="${item}"
                                    <#if e.role_dbPrivilege?? && e.role_dbPrivilege==item>selected="selected" </#if>>${map_dbPrivilege[item]}</option>
                        </#list>
                    </select>
                </td>
            </tr>
                ...
                <td style="text-align: left;">
                    <select name="status" id="status" class="input-small">
                        ...
                        <#list y_n?keys as item>
                            <option value="${item}"
                                    <#if e.status?? && e.status==item>selected="selected" </#if>>${y_n[item]}</option>
                        </#list>
                    </select>
                </td>
            </tr>
