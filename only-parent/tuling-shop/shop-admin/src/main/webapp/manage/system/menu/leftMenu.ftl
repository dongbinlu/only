<div id="menuContainer" style="background-color: #C1DAD7">
    ...
    <div id="loadID" style="display: none;">
        ...
        <div style="display: none;">
            属性( key )：<input type="radio" id="name" name="keyType" class="radio first"
            ...
            <input type="radio" id="getNodesByParamFuzzy" name="funType" class="radio" style="margin-left:36px;"
                   checked/><span>getNodesByParamFuzzy (only string)</span><br/>
